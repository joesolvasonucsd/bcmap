...
# Usage
#	python x3.bc2enchancer.py </dir/to/input/data/> <dir/to/dict/> <number_inputs_x2.collapsed2counts.py> <min_enhancer_activation> <sampleName> <memory_gigs> <hrs_requested> <email>
...
bc2enhancer='2.bc2enhancer_random-Bkgd.py'
