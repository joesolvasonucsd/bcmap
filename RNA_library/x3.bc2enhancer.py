...
# Usage
#	python x3.bc2enchancer.py <2.barcode2enhacner.py_variant> </dir/to/input/data/> <dir/to/dict/> <number_inputs_x2.collapsed2counts.py> <min_enhancer_activation> <sampleName> <memory_gigs> <hrs_requested> <email>
